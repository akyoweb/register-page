    ...
    <div class="main">
        <div class="box">
            ...
            <form action="login.php" method="POST">
                ...
                <div class="din">
                    <input name="namefull" id="namefull" class="in1" type="text" placeholder="نام کاربری خود را وارد کنید">
                ...
                <div class="din">
                    <input name="phone" id="phone" class="in1" type="tel" placeholder="شماره خود را وارد کنید">
                ...
                <div class="din">
                    <input name="password" id="password" class="in1" type="password" placeholder="رمز خود را وارد کنید">
